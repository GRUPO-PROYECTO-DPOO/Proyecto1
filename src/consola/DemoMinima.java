...
public class DemoMinima {
  public static void main(String[] args) {
    ...
    // 1) Usuarios mínimos
    Cliente cli = new Cliente("cami","123","Camila","cami@x.com");
    Organizador org = new Organizador("org1","123","Org Uno","org@x.com");
    Administrador admin = new Administrador("admin","123","Admin","a@x.com");
    ctx.usuarios.put(cli.getLogin(), cli);
    ctx.usuarios.put(org.getLogin(), org);
    ctx.usuarios.put(admin.getLogin(), admin);

    // 2) Venue: proponer y aprobar
    ...
    System.out.printf("[COT] base=%.2f cargo=%.2f cuota=%.2f total=%.2f%n",
    ...
    // 5) Reembolso por cancelación de ADMIN
